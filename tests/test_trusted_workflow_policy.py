...
MERGED_MAIN_COMMIT = "7b549978239455f12620429ffc06a553a1a0dd41"
...
.github/workflows/backend_security.yml ba723b29efd4e00f2849173bcd7ce43a8203eb3a6bd3fd3e060f997cce9d5bbb
...
backend/deploy/README.md 2a1a9277ec8b797ac2cc1776982f6a4a4a6711c1afaca7b83b4bd726e817af7d
...
backend/deploy/sgk_backend_deploy.sh afda60b403988653ed92b0714fa25dc97980d1103c5709d0090fb49e9889ab7e
...
backend/tests/test_nas_backend_deploy.py aba8b7803c4c94cbb2f7fafd15f84cd7f7ad7a3bcf0ba4d791740b02239ae594
...
class TrustedWorkflowPolicyTest(unittest.TestCase):
  def assert_current_main_baseline_is_exact(self, policy):
    ...
    self.assertEqual(exact["id"], "temporary-ephemeral-ghcr-auth-7b54997")
    self.assertEqual(exact["mode"], "temporary-exact")
    self.assertEqual(
        persistent["id"],
        "future-ephemeral-ghcr-auth-7b54997-persistent-baseline",
    )
  ...
  def test_transition_has_exact_and_future_persistent_baselines(self):
    ...
    self.assertEqual(bundle["id"], "temporary-ephemeral-ghcr-auth-7b54997")
    ancestry.assert_not_called()
    self.assertEqual(
