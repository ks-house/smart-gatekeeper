...
MERGED_MAIN_COMMIT = "f5e2528d47e657226354a1ff80f0f11d6fdab01a"
EXPECTED_BUNDLE_ID = "durable-mqtt-terminal-f5e2528-persistent-baseline"
MERGED_MAIN_DIGEST_LINES = """\
.github/workflows/deploy.yml 8c20d0f8126a351b065b6645d9909b71646c5e93e4fb0012085f0a8e2e66cad8
...
scripts/ops_commercial_gate.py d7451c6f121e303075d3e67e25d154ec27651366d6123382cbb81fa85b1806fd
ops/backend_trusted_bundle_paths.json 09bece4fd6e16e5e3170dde779d781f8299c4fd1c08e4111a8e326829f6db5da
...
backend/.env.example 8bd868777177cd03850012b248f8bdb247b30857ab2415d975948dfa489b5a4a
...
backend/app/main.py 12e5e16626c7853404a61791eaaf952e94a622b26db46870cc6124ace7bc4a23
...
backend/db/Dockerfile f196ba8bef3d145e9b599f12e6f60581aece932f3113477a6b46e6ca568381f2
...
backend/db/schema.env 96fe374395ee7f994b28078839c8b6aa48577e4a79c1bdc29a5f5fb163725779
...
backend/docker-compose.yml 5a733da479799956f52825efb5863b9885df120fe6c56bb648a3f5fc073cc13b
...
backend/tests/test_nas_backend_deploy.py cfe06207e312b16c2106b4196f634bcb677e68998c83ca7fb3b965df80849b98
...
backend/tests/test_target_boot_registry.py 6aa356aaba3efc2d33fc4c06f6f7c20c7b63701e7e92d1aff6a7108b76ad9365
...
class TrustedWorkflowPolicyTest(unittest.TestCase):
  def assert_current_main_baseline_is_exact(self, policy):
    ...
    self.assertEqual(len(policy["protected_paths"]), 100)
    self.assertEqual(
  ...
  def test_current_workflow_inventory_and_candidate_digests_are_coherent(self):
    ...
    self.assertEqual(len(FEATURE_CHANGED_PROTECTED_PATHS), 6)
    self.assertEqual(len(locally_unchanged_protected), 94)
