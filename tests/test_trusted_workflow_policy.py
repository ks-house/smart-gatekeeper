...
MERGED_MAIN_COMMIT = "ecc189e8d1ab21ad0c797b3a6009f3f12ac48829"
...
backend/deploy/bootstrap_legacy_synology.sh 1969b5a8e6376611bf80ffef0484f6a084cb8bad3df9bed7de4e20b96b1e4001
...
backend/tests/test_nas_backend_deploy.py ce8b1dff3ac8e58358fbdfdaf8c876c0725e50d2280f411a68013eddff06ed0c
...
class TrustedWorkflowPolicyTest(unittest.TestCase):
  def assert_current_main_baseline_is_exact(self, policy):
    ...
    self.assertEqual(exact["id"], "temporary-bootstrap-runtime-ecc189e")
    self.assertEqual(exact["mode"], "temporary-exact")
    self.assertEqual(
        persistent["id"],
        "future-bootstrap-runtime-ecc189e-persistent-baseline",
    )
  ...
  def test_transition_has_exact_and_future_persistent_baselines(self):
    ...
    self.assertEqual(bundle["id"], "temporary-bootstrap-runtime-ecc189e")
    ancestry.assert_not_called()
    self.assertEqual(
