...
MERGED_MAIN_COMMIT = "e787786f2514c641e02dd5608d0fe21c4476eca4"
...
backend/compose.synology.yml fa0f88acdfd0c6de87b6fde278804c673f18f07a099e5844d2b21ac10be451a2
...
backend/deploy/README.md a7dad4437568d8c76a1ffe96dac9011565a1952fdc4f4bc0f29b9b1fc709293e
...
backend/deploy/sgk_backend_deploy.sh 6a29bf87f1e5b91050cc37c5bcff260564e95abd41dd8749d37a8f63514cf805
...
backend/tests/test_nas_backend_deploy.py f79ba51e87045e1731542602a588c6f2f63aebcc1dad64497b1f39a0714f64bd
...
class TrustedWorkflowPolicyTest(unittest.TestCase):
  def assert_current_main_baseline_is_exact(self, policy):
    ...
    self.assertEqual(exact["id"], "temporary-dsm-backend-compat-e787786")
    self.assertEqual(exact["mode"], "temporary-exact")
    self.assertEqual(
        persistent["id"],
        "future-dsm-backend-compat-e787786-persistent-baseline",
    )
  ...
  def test_transition_has_exact_and_future_persistent_baselines(self):
    ...
    self.assertEqual(bundle["id"], "temporary-dsm-backend-compat-e787786")
    ancestry.assert_not_called()
    self.assertEqual(
