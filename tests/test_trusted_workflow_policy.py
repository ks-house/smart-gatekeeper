...
MERGED_MAIN_COMMIT = "9565f67cf16d78342ac7ebbb9035a5517bd5cdb2"
MERGED_MAIN_DIGEST_LINES = """\
.github/workflows/deploy.yml 76325aac1a37b982f3efd2f317a4ed85af6939c3120a616468e15b7a33320b7f
...
class TrustedWorkflowPolicyTest(unittest.TestCase):
  def assert_current_main_baseline_is_exact(self, policy):
    ...
    self.assertEqual(temporary["id"], "temporary-gatt-action2-9565f67")
    self.assertEqual(temporary["mode"], "temporary-exact")
    self.assertEqual(
        persistent["id"],
        "future-gatt-action2-9565f67-persistent-baseline",
    )
  ...
  def test_transition_has_exact_and_future_persistent_baselines(self):
    ...
    self.assertEqual(bundle["id"], "temporary-gatt-action2-9565f67")
    ancestry.assert_not_called()
    self.assertEqual(
