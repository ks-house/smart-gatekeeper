...
MERGED_MAIN_COMMIT = "e2ecc68f9e5f7a15c9ca9319d244c99bc778f371"
EXPECTED_BUNDLE_ID = "future-family-phone-enrollment-e2ecc68-persistent-baseline"
...
scripts/ops_commercial_gate.py 39e439a9608876183306c53da8c35b6359c9dcaa80641c1fb19f1ac9c3750a83
ops/backend_trusted_bundle_paths.json 20acd5d98306bdd1b91806d1231158df0bd0a1231482a1162f1414923be766d0
...
backend/app/acl_management.py 92a18e1bb8d2444e49429e1eea5fb7c7aeff92b7fbd8351220c08fcbf9f29156
...
backend/app/main.py 531bb166412ab57168e0764d42270382548d9e971dd6fecccee4cfa8e9374da7
...
backend/tests/test_acl_api.py e949c88aabc00c9c3597117796cd6482413694c9b6e3d9c012602a94d59fcc5e
...
backend/tests/test_admin_security.py b4807949acb0a5b2969b5879d2f17deff059cbceb854ae05a59beed218f5edda
...
class TrustedWorkflowPolicyTest(unittest.TestCase):
  def assert_current_main_baseline_is_exact(self, policy):
    ...
    self.assertEqual(len(policy["protected_paths"]), 86)
    self.assertEqual(
  ...
  def test_current_workflow_inventory_and_candidate_digests_are_coherent(self):
    ...
    self.assertEqual(len(locally_unchanged_protected), 84)
