...
MERGED_MAIN_COMMIT = "91858585f8db6fb1b8b50ca0182526fdb653f0bf"
MERGED_MAIN_DIGEST_LINES = """\
.github/workflows/deploy.yml e46ba83350633b13fd13ad5f5fdee2024481d2eab4857bca3f231a2ad003d409
...
class TrustedWorkflowPolicyTest(unittest.TestCase):
  def assert_current_main_baseline_is_exact(self, policy):
    ...
    self.assertEqual(temporary["id"], "temporary-manual-open-9185858")
    self.assertEqual(temporary["mode"], "temporary-exact")
    self.assertEqual(
        persistent["id"],
        "future-manual-open-9185858-persistent-baseline",
    )
  ...
  def test_transition_has_exact_and_future_persistent_baselines(self):
    ...
    self.assertEqual(bundle["id"], "temporary-manual-open-9185858")
    ancestry.assert_not_called()
    self.assertEqual(
