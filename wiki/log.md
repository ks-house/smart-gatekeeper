...
- Replaced both transition identities with revised feature commit `829c98da21ddcb90c891fa03cbb51282a4fcf0eb`; its complete 62-file maps are identical to each other and differ from the first authorization only for `build_app.yml` and `scripts/ota_contract_gate.py`.
