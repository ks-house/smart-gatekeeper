...
| [android_gatt_worker.md](android_gatt_worker.md) | #17 default-OFF native GATT credential worker, canonical Keystore proof, durable retry/diagnostics, hardwareless evidence and pending physical gates |
