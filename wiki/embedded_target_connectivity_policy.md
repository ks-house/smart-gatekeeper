...
- MQTTS가 끊긴 동안에도 재접속을 계속한다. 9월14일 로컬 보완 구현은 5–6초, 10–12초, 20–24초, 최대30초의 jitter backoff를 사용하며 60초 연속 연결 후 초기화한다. keepalive는 120초 그대로다. 짧은 성공으로 backoff를 지우지 않고 Wi-Fi/계획 OTA 복귀 첫 시도만 즉시 허용한다. 배포 여부와 계측 범위는 [MQTT 보완 기록](mqtt_stability_analysis_2026_09_14.md)의 §8을 따른다.
