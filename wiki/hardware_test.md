...
| Corrective memory build | Resident97400→88120B, flash1856082/7340032B;412 root tests OK(1 skip), focused33/OTA contract PASS | Health thresholds and immutable wire unchanged |
| Corrective498 installation | main7959962, encrypted1932708B/SHA256663e9ee0e8bc8398e35e8a53b2034e3d6b3270b3305a5321d50d3544e6ecb839; boot904,23:27:08 VALID, health13723 at23:30:44 uptime253s/same boot/relay OFF | Install and health PASS; no physical door command |
| Post-VALID operation | Own periodic HTTPS CURRENT/error0/persisted, MQTT restored, BLE apply-ready/no gaps, auth_ready/no passage lock | Software-advertising flag is not over-air/phone reception evidence; physical test pending |
...
## 2026-09-05 OTA heap-headroom installed health

| Test | Observed result | Verdict / boundary |
|---|---|---|
| Reviewed final main | Policy PR #372, feature PR #373 and final policy PR #374 passed required hosted checks; final main is `6701f32b95116514698d7a66672738b31062b736` | PASS for reviewed source and trusted baseline |
| Final signed publication | Run `33968334706` signed, encrypted, atomically published and HTTPS-read-back `2.1.462+main.g6701f32`, build ID `main-462-6701f32b95116514698d7a66672738b31062b736` | PASS for exact artifact publication |
| Safe preflight and single request | Recovered boot 735 / exact 452 was IDLE, relay OFF, MQTT 1/1, BLE active and stable through uptime 892 seconds. One HA request received PUBACK, Backend `target_accepted` and Target result 0 | PASS for one accepted request; no duplicate was sent |
| Exact install | Target advanced once to boot 736 / boot ID `c563d15ba2ebb669d6c77fc5d574acc6`, exact 462, SOFTWARE reset and `ota_pending_verify` breadcrumb | PASS for inactive-slot installation and reboot identity |
| Runtime headroom | Exact 462 reported free heap 69,624–69,812 B initially, largest block 64,500 B and minimum heap 61,224 B by uptime 50 seconds. At uptime 137, free heap was 69,164 B and largest block 38,900 B | The old 65,536 B instantaneous requirement had insufficient field margin; the new 48 KiB aggregate / 32 KiB contiguous requirements remain satisfied |
