...
class ReliabilityContractTest(unittest.TestCase):
    ...
    def test_classifier_separates_positive_reason_from_failure_and_sensor_evidence(self):
        ...
        self.assertEqual("ARM_WINDOW_EXPIRED_WITHOUT_SENSOR_TRIGGER", result["interpretation"])
        self.assertEqual("UNDETERMINED", result["physical_failure"])
        self.assertEqual("RECORDED_STAGE_SPAN_NOT_USER_WAIT", result["source_span_meaning"])
